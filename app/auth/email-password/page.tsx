...
export default function EmailPasswordPage() {
  ...
  return (
    <AuthForm title="Create your account" subtitle="Sign up with email and password">
      <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
        ...
        <p className="text-center text-sm text-gray-600">
          Or{' '}
          <Link href="/auth/otp" className="font-semibold text-indigo-600 hover:text-indigo-500">
            sign in with OTP
          </Link>
        </p>
      </form>
